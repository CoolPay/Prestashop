...
class CoolPay extends PaymentModule
{
    ...
    public function __construct()
    {
        ...
        $this->displayName = $this->l('Coolpay');
        $this->description = $this->l('Accept payments by Coolpay');
        $this->description = $this->l('Payment via Coolpay');
    ...
    public function uninstall()
    {
        ...
        return Configuration::deleteByName('_COOLPAY_OVERLAY_CODE') &&
            Configuration::deleteByName('_COOLPAY_ORDERING') &&
            Configuration::deleteByName('_COOLPAY_HIDE_IMAGES');
    }

    public function getSetup()
    {
        $this->setup_vars = array(
            array('_COOLPAY_MERCHANT_ID', 'merchant_id',
                $this->l('Coolpay merchant ID'), '', ''),
            array('_COOLPAY_PRIVATE_KEY', 'private_key',
                $this->l('Coolpay private key'), '', ''),
            array('_COOLPAY_USER_KEY', 'user_key',
                $this->l('Coolpay user key'), '', ''),
            array('_COOLPAY_ORDER_PREFIX', 'orderprefix',
                $this->l('Order prefix'), '000', ''),
            array('_COOLPAY_GA_CLIENT_ID', 'ga_client_id',
                $this->l('Google analytics client ID'), '', ''),
            array('_COOLPAY_GA_TRACKING_ID', 'ga_tracking_id',
                $this->l('Google analytics tracking ID'), '', ''),
            array('_COOLPAY_STATEMENT_TEXT', 'statementtext',
                $this->l('Text on statement'), '', ''),
            array('_COOLPAY_TESTMODE', 'testmode',
                $this->l('Accept test payments'), 0, ''),
            array('_COOLPAY_COMBINE', 'combine',
                $this->l('Creditcards combined window'), 0, ''),
            array('_COOLPAY_AUTOGET', 'autoget',
                $this->l('Cards in payment window controlled by CoolPay'), 0, ''),
            array('_COOLPAY_AUTOFEE', 'autofee',
                $this->l('Customer pays the card fee'), 0, ''),
            array('_COOLPAY_API', 'api',
                $this->l('Activate API'), 1, ''),
            array('_COOLPAY_SHOWCARDS', 'showcards',
                $this->l('Show card logos in left column'), 1, ''),
            array('_COOLPAY_SHOWCARDSFOOTER', 'showcardsfooter',
                    $this->l('Show card logos in footer'), 1, ''),
            array('_COOLPAY_AUTOCAPTURE', 'autocapture',
                    $this->l('Auto-capture payments'), 0, ''),
            array('_COOLPAY_STATECAPTURE', 'statecapture',
                    $this->l('Capture payments in state'), 0, ''),
            array('_COOLPAY_BRANDING', 'branding',
                    $this->l('Branding in payment window'), 0, ''),
            array('_COOLPAY_FEE_TAX', 'feetax',
                    $this->l('Tax for card fee'), 0, ''),
            array('_COOLPAY_VIABILL', 'viabill',
                    $this->l('ViaBill - buy now, pay whenever you want'), 0, 'viabill'),
            array('_COOLPAY_DK', 'dk',
                    $this->l('Dankort'), 0, 'dankort'),
            array('_COOLPAY_VISA', 'visa',
                    $this->l('Visa card'), 0, 'visa,visa-dk'),
            array('_COOLPAY_VELECTRON', 'visaelectron',
                    $this->l('Visa Electron'), 0, 'visa-electron,visa-electron-dk'),
            array('_COOLPAY_MASTERCARD', 'mastercard',
                    $this->l('MasterCard'), 0, 'mastercard,mastercard-dk'),
            array('_COOLPAY_MASTERCARDDEBET', 'mastercarddebet',
                    $this->l('MasterCard Debet'), 0, 'mastercard-debet-dk'),
            array('_COOLPAY_A_EXPRESS', 'express',
                    $this->l('American Express'), 0, 'american-express,american-express-dk'),
            array('_COOLPAY_MOBILEPAY', 'mobilepay',
                    $this->l('MobilePay'), 0, 'mobilepay'),
            array('_COOLPAY_SWISH', 'swish',
                    $this->l('Swish'), 0, 'swish'),
            array('_COOLPAY_KLARNA', 'klarna',
                    $this->l('Klarna'), 0, 'klarna'),
            array('_COOLPAY_FORBRUGS_1886', 'f1886',
                    $this->l('Forbrugsforeningen af 1886'), 0, 'fbg1886'),
            array('_COOLPAY_DINERS', 'diners',
                    $this->l('Diners Club'), 0, 'diners,diners-dk'),
            array('_COOLPAY_JCB', 'jcb',
                    $this->l('JCB'), 0, 'jcb'),
            array('_COOLPAY_VISA_3D', 'visa_3d',
                    $this->l('Visa card (3D)'), 0, '3d-visa,3d-visa-dk'),
            array('_COOLPAY_VELECTRON_3D', 'visaelectron_3d',
                    $this->l('Visa Electron (3D)'), 0, '3d-visa-electron,3d-visa-electron-dk'),
            array('_COOLPAY_MASTERCARD_3D', 'mastercard_3d',
                    $this->l('MasterCard (3D)'), 0, '3d-mastercard,3d-mastercard-dk'),
            array('_COOLPAY_MASTERCARDDEBET_3D', 'mastercarddebet_3d',
                    $this->l('MasterCard Debet (3D)'), 0, '3d-mastercard-debet-dk'),
            array('_COOLPAY_MAESTRO_3D', 'maestro_3d',
                    $this->l('Maestro (3D)'), 0, '3d-maestro,3d-maestro-dk'),
            array('_COOLPAY_JCB_3D', 'jcb_3d',
                    $this->l('JCB (3D)'), 0, '3d-jcb'),
            array('_COOLPAY_PAYEX', 'payex',
                    $this->l('PayEx'), 0, 'creditcard'),
            array('_COOLPAY_DANSKE', 'danske',
                    $this->l('Danske'), 0, 'danske-dk'),
            array('_COOLPAY_NORDEA', 'nordea',
                    $this->l('Nordea'), 0, 'nordea-dk'),
            array('_COOLPAY_PAYPAL', 'paypal',
                    $this->l('PayPal'), 0, 'paypal'),
            array('_COOLPAY_SOFORT', 'sofort',
                    $this->l('Sofort'), 0, 'sofort'),
            array('_COOLPAY_APPLEPAY', 'applepay',
                    $this->l('Apple Pay'), 0, 'applepay'),
            array('_COOLPAY_BITCOIN', 'bitcoin',
        ...
        $autoget = Configuration::get('_COOLPAY_AUTOGET');
        $combine = Configuration::get('_COOLPAY_COMBINE');
    ...
    {
        $ordering = Configuration::get('_COOLPAY_ORDERING');
        if ($ordering) {
    ...
    {
        $hide_images = Configuration::get('_COOLPAY_HIDE_IMAGES');
    ...
    public function changeState()
    {
        ...
        Configuration::updateValue('_COOLPAY_HIDE_IMAGES', implode(',', $hide_images_list));
    }
    ...
    public function updateCardsPosition()
    {
        ...
        if ($cards) {
            Configuration::updateValue('_COOLPAY_ORDERING', implode(',', $cards));
        }
    }
    ...
    public function getContent()
    {
        ...
        $row = Db::getInstance()->ExecuteS(
            'SHOW TABLES LIKE "'._DB_PREFIX_.'coolpay_execution"'
        );
        if (!$row) {
        ...
        if (Tools::getValue('submitCoolPayModule') && !$this->post_errors) {
            $output .= '
        ...
        $this->context->smarty->clearCompiledTemplate(
            $this->local_path.'views/templates/hook/coolpay.tpl'
        );
    ...
    protected function renderForm()
    {
        ...
        $helper->submit_action = 'submitCoolPayModule';
        if ($this->v15) {
            $helper->currentIndex =
    ...
    protected function postProcess()
    {
        ...
        if (Tools::getValue('submitCoolPayModule')) {
            foreach ($this->setup_vars as $setup_var) {
                $vars = $this->varsObj($setup_var);
                if ($vars->card_type_lock) {
                    continue;
            ...
            if ($vars->message == 'Invalid API key') {
                $this->post_errors[] = $this->l('Invalid Coolpay user key. Check the key at').
                    ' <a href="https://manage.coolpay.com">https://manage.coolpay.com</a>.';
    ...
    public function getCurlHandle($resource, $fields = null, $method = null)
    {
        ...
        $url = 'https://api.coolpay.com/'.$resource;
        if ($method == null) {
            if ($fields) {
                $method = 'POST';
            } else {
    ...
    public function makePayment($params, &$paymentOptions, $select_option = 0)
    {
        if (function_exists('stream_resolve_include_path') &&
            stream_resolve_include_path(
                _PS_MODULE_DIR_.'coolpay/coolpay.inc.php'
            )
        ) {
            include(_PS_MODULE_DIR_.'coolpay/coolpay.inc.php');
        }
        $setup = $this->getSetup();
        $hide_images_list = $this->imagesSetup();
        ...
        foreach ($setup_vars as $setup_var) {
            ...
            if ($this->v17 && empty($cart->qpPreview)) {
                ...
                $tpl = 'module:coolpay/views/templates/hook/coolpay17.tpl';
                ...
                $html .= $this->display(__FILE__, 'views/templates/hook/coolpay.tpl');
            }
        }
    ...
    public function hookLeftColumn()
    {
        ...
        if ($ordering_list) {
            ...
            return $this->display(__FILE__, 'views/templates/hook/leftcoolpay.tpl');
        }
        return '';
    }
    ...
    public function hookFooter()
    {
        ...
        if ($ordering_list) {
            $smarty->assign('ordering_list', $ordering_list);
            return $this->display(__FILE__, 'views/templates/hook/footercoolpay.tpl');
        }
        return '';
    }
    ...
    public function hookPaymentReturn($params)
    {
        ...
        if ($state == _PS_OS_ERROR_) {
            $status = 'callback';
            $msg = 'CoolPay: Confirmation failed';
    ...
    public function hookAdminOrder($params)
    {
        ...
        if ($this->v16) {
            $html = '<div class="row"><div class="col-lg-5 panel">
                ...
                '.$this->l('Coolpay API').'</div>';
        } else {
            $html = '<br />
                <fieldset>
                <legend>'.$this->l('Coolpay API').'</legend>';
        }
        ...
        $html .= '<a href="https://manage.coolpay.com" target="_blank" style="color: blue;">'.
            $this->l('Coolpay manager').'</a>';
        if ($this->v16) {
            $html .= '</div></div>';
        } else {
            $html .= '</fieldset>';
    ...
    public function hookPDFInvoice($params)
    {
        ...
        if (isset($trans['trans_id'])) {
            ...
            if ($this->v15) {
                $html = '<table><tr>';
                $html .= '<td style="width:100%; text-align:right">Coolpay transaction ID: '.
                    $trans['trans_id'].'</td>';
                $html .= '</tr></table>';
                if (isset($vars->acquirer) && $vars->acquirer == 'viabill') {
                    $html .= '<br/>';
                    $html .='Det skyldige belÃƒÂ¸b kan alene betales med frigÃƒÂ¸rende virkning til ViaBill, ';
                    $html .= 'som fremsender sÃƒÂ¦rskilt opkrÃƒÂ¦vning.';
                    $html .= '<br/>';
                ...
                if (isset($vars->acquirer) && $vars->acquirer == 'viabill') {
                    ...
                    $txt = Tools::iconv(
                        'utf-8',
                        $encoding,
                        'Det skyldige belÃƒÂ¸b kan alene betales med frigÃƒÂ¸rende virkning til ViaBill, '.
                        'som fremsender sÃƒÂ¦rskilt opkrÃƒÂ¦vning.'
                    );
    ...
    public function hookPostUpdateOrderStatus($params)
    {
        ...
        $order = new Order($params['id_order']);
        $capture_statue = Configuration::get('_COOLPAY_STATECAPTURE');
    ...
    public function payment()
    {
        ...
        if (!Validate::isLoadedObject($cart)) {
            $msg = 'CoolPay: Payment error. Not a valid cart';
        ...
        if (empty($vars->id)) {
            ...
            if (isset($vars->message)) {
                if (isset($saved_vars->message)) {
                    $msg = 'CoolPay: Payment error: '.$saved_vars->message;
                    Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
                    die($saved_vars->message);
                } else {
                    $msg = 'CoolPay: Payment error: '.$vars->message;
                    Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
                    die($vars->message);
                }
            }
            ...
            if (empty($vars->id)) {
                if (empty($this->qp_error)) {
                    ...
                    $msg = 'CoolPay: cURL error: '.$this->qp_error;
                }
                Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
                die($msg);
            }
        ...
        Db::getInstance()->Execute(
            'INSERT INTO '._DB_PREFIX_.'coolpay_execution
            (`id_cart`, `trans_id`, `order_id`, `accepted`, `test_mode`, `json`)
            VALUES '.$this->group($values)
        );
        if ($vars->accepted) {
            // Already paid
            $msg = 'CoolPay: Payment notice: Already paid';
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
        ...
        if ($currency->iso_code != $vars->currency) {
             ...
             */
            $msg = sprintf(
                'CoolPay: Payment error: Currency was changed from %s to %s',
                $vars->currency,
                $currency->iso_code
            );
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
    ...
    public function validate($json, $checksum, $id_order_state = _PS_OS_PAYMENT_)
    {
        ...
        if ($checksum != $this->sign($json, $this->setup->private_key)) {
            $msg = 'CoolPay: Validate error. Checksum failed. Check private key in configuration';
            Logger::addLog($msg, 2);
            die('Checksum failed');
        }
        ...
        if ($test_mode && !$this->setup->testmode) {
            $cart->delete();
            $msg = 'CoolPay: Validate error. Will not accept test payment!';
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
        ...
        if (!Validate::isLoadedObject($cart)) {
            $msg = 'CoolPay: Validate error. Not a valid cart';
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
            die('Not a valid cart');
        }
        ...
        if ($currency->iso_code != $vars->currency) {
            $msg = sprintf(
                'CoolPay: Validation error: Currency was changed from %s to %s',
                $vars->currency,
                $currency->iso_code
            );
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
        ...
        if ($trans['accepted']) {
            $msg = 'CoolPay: Validate error. Order already accepted';
            Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
        ...
        if ($accepted && $amount) {
            try {
                ...
                if (!$this->validateOrder(
                    ...
                    $msg = 'CoolPay: Validate error. Unable to process order';
                    Logger::addLog($msg, 2, 0, 'Cart', $id_cart);
                    die('Prestashop error - unable to process order..');
                }
            } catch (Exception $exception) {
                Db::getInstance()->Execute(
                    'UPDATE '._DB_PREFIX_.'coolpay_execution
                    SET `accepted` = 0
                    WHERE `id_cart` = '.$id_cart
                );
                $msg = 'CoolPay: Validate error. Exception ';
