...
<form action="{$payment_url|escape:'javascript':'UTF-8'}" method="post" id="coolpay{$type|escape:'htmlall':'UTF-8'}">
...
<p class="payment_module coolpay">
	<a style="height:auto" href="javascript:$('#coolpay{$type|escape:'htmlall':'UTF-8'}').submit()">
