...
<h4>
	{l s='Payment methods' mod='coolpay'}
</h4>
...
<div class="col-xs-3 col-sm-6" style="float: left; padding-left: 0px;">
  	<img style="margin-bottom: 10px;" src="{$module_dir|escape:'htmlall':'UTF-8'}views/imgf/{$var_name|escape:'htmlall':'UTF-8'}.gif" alt="{l s='Credit card' mod='coolpay'}" />
</div>
{/foreach}
</div>
</section>
